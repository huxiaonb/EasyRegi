...
var Client = function () {
  ...
  (0, _createClass3.default)(Client, [{
    key: 'request',
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(method, resource, type, requestBody) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 8;
                return httpx.request(url, (0, _assign2.default)(opts, {
                  method: method,
                  headers: headers,
                  data: requestBody
                }));
              ...
              case 29:
                ...
                body = {};
                (0, _keys2.default)(responseData[type]).forEach(function (key) {
                  if (key !== '$') {
    ...
    value: function buildHeaders(method, body, resource, customHeaders) {
      ...
      (0, _assign2.default)(headers, customHeaders);
    ...
    key: 'listQueue',
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(start, limit, prefix) {
    ...
    value: function () {
      var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(queueName, params) {
    ...
    value: function () {
      var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(queueName, numOfMessages, waitSeconds) {
    ...
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(queueName, numOfMessages) {
        var url, subType, response;
    ...
    value: function () {
      var _ref6 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee6(queueName, receiptHandles) {
    ...
    key: 'listTopic',
    value: function () {
      var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(start, limit, prefix) {
        var customHeaders, subType, response;
