...
module.exports = function (app) {
    ...
    app.route('/details/:positionid').get(weChatController.detailPosition);
    ...
    app.route('/charge').post(weChatController.charge);
    app.route('/orderQuery').post(weChatController.orderQuery);
